...
```{r tidysite, fig.cap = "Site summary of the tidy building subset", fig.width=8, fig.height=8}
...
```{r chwst, fig.cap = "Proposed chilled water supply temperature reset based on outdoor temperature", fig.width=6, fig.height=4}
...
temperature. Figure \@ref(fig:occchange) shows one example
