...
df_model_acc_stable <- read_rds("../readfiles/stable/df_model_acc.rds")
df_model_acc_variable <- read_rds("../readfiles/variable/df_model_acc.rds")

df_model_acc_variable %>% 
  mutate(group = "variable") %>% 
  rbind(df_model_acc_stable %>% mutate(group = "stable")) %>% 
