...
```{r absnull, fig.cap="Comparison between the two M&V methods in detecting no intervention effect (expressed without absolute calculation) when buildings are subject to baseline change.", fig.height=4, fig.width=9}
#### ABS-NULL ####
...
```{r meancont, fig.cap="Comparison of different sampling ratio impact on M&V estimation accuracy (expressed without absolute calculation for errors)", fig.height=7, fig.width=9}
...
ggarrange(p_top, p_bottom, 
          ...
          common.legend = T, 
          legend = "bottom") +
  plot_annotation(title = "Estimated error in savings estimation of randomized M&V\nafter satisfying all stopping criteria")
